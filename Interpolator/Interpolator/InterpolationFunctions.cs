...
namespace ExplodingCable.Interpolator
{
	...
	/// </summary>
	/// <remarks>
	/// Use these if garbage collection is an issue.
	/// </remarks>
	public static class InterpolationFunctions
	{
		...
		public static float Linear(double start, double end, double current, double max, bool overshoot,
			bool undershoot)
		{
		...
		public static float EaseIn(double start, double end, double power, double current, double max, bool overshoot,
			bool undershoot)
		{
		...
		public static float EaseOut(double start, double end, double power, double current, double max, bool overshoot,
			bool undershoot)
		{
